...
local library = utility.table({theme = table.clone(themes.Default), folder = "voidhook", extension = "vozoid", flags = {}, open = true, keybind = Enum.KeyCode.RightShift, mousestate = services.InputService.MouseIconDisabled, cursor = nil, holder = nil, connections = {}}, true)
