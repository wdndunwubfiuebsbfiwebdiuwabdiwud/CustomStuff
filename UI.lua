...
local themes = {
    Default = {
        ["Accent"] = Color3.fromRGB(53, 53, 151),
...
local library = utility.table({theme = table.clone(themes.Default), folder = "vozoiduilib", extension = "vozoid", flags = {}, open = true, keybind = Enum.KeyCode.RightShift, mousestate = services.InputService.MouseIconEnabled, cursor = false, holder = nil, connections = {}}, true)
local decode = (syn and syn.crypt.base64.decode) or (crypt and crypt.base64decode) or base64_decode
library.gradient = decode("")
